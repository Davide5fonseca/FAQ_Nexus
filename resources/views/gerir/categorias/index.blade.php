...
<div class="cartao">
    ...
    <form method="post" action="{{ route('gerir.categorias.store') }}" novalidate style="display:flex;gap:.5rem;flex-wrap:wrap;align-items:flex-start">
        @csrf
...
@if($categories->isEmpty())
    <div class="vazio">
        <div class="vazio__icone" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg></div>
...
@else
    ...
    <ul class="lista-edit">
        @foreach($categories as $cat)
            <li>
                <form method="post" action="{{ route('gerir.categorias.update', $cat) }}" class="editar" novalidate>
                    @csrf @method('PUT')
                ...
                <form method="post" action="{{ route('gerir.categorias.destroy', $cat) }}"
